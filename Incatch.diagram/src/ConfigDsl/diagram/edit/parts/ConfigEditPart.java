...
public class ConfigEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "ConfigDsl"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConfigDsl.diagram.edit.policies.ConfigItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ConfigDsl.diagram.edit.policies.ConfigCanonicalEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				ConfigDsl.diagram.part.ConfigDslVisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new ConfigDsl.diagram.edit.commands.ConfigDslCreateShortcutDecorationsCommand(
