 ...
 * @generated
 */
public class DynamicListFieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DynamicListFieldNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConfigDsl.diagram.providers.ConfigDslParserProvider.getParser(
					ConfigDsl.diagram.providers.ConfigDslElementTypes.DynamicListField_2003, getParserElement(),
