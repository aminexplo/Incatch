 ...
 * @generated
 */
public class SimpleStringFieldNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SimpleStringFieldNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ConfigDsl.diagram.edit.policies.ConfigDslTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ConfigDsl.diagram.providers.ConfigDslElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConfigDsl.diagram.providers.ConfigDslParserProvider.getParser(
					ConfigDsl.diagram.providers.ConfigDslElementTypes.SimpleStringField_2002, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ConfigDsl.diagram.edit.parts.ConfigDslEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
