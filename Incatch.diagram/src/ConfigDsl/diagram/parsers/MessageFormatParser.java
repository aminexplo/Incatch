 ...
 * 
 */
package ConfigDsl.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ConfigDsl.diagram.part.ConfigDslDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ConfigDsl.diagram.part.Messages.MessageFormatParser_InvalidInputError,
