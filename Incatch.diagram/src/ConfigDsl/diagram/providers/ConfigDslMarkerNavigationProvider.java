 ...
 * @generated
 */
public class ConfigDslMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ConfigDsl.diagram.part.ConfigDslDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ConfigDsl.diagram.part.ConfigDslDiagramEditorUtil.selectElementsInDiagram(editor,
