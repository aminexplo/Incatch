 ...
 * @generated
 */
public class ConfigDslShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = ConfigDsl.diagram.part.ConfigDslDiagramEditorPlugin.getInstance()
