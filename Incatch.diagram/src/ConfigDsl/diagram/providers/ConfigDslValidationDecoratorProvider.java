 ...
 * @generated
 */
public class ConfigDslValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ConfigDsl.diagram.part.ConfigDslDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ConfigDsl.diagram.part.ConfigDslDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ConfigDsl.diagram.edit.parts.ConfigEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				ConfigDsl.diagram.part.ConfigDslDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
