 ...
 * @generated
 */
public class ConstraintCollectionEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "ConstraintDsl"; //$NON-NLS-1$
	...
	* @generated
	*/
	public ConstraintCollectionEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConstraintDsl.diagram.edit.policies.ConstraintCollectionItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ConstraintDsl.diagram.edit.policies.ConstraintCollectionCanonicalEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				ConstraintDsl.diagram.part.ConstraintDslVisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new ConstraintDsl.diagram.edit.commands.ConstraintDslCreateShortcutDecorationsCommand(
