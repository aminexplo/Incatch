 ...
 * @generated
 */
public class RangeRuleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RangeRuleNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ConstraintDsl.diagram.edit.policies.ConstraintDslTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ConstraintDsl.diagram.providers.ConstraintDslElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConstraintDsl.diagram.providers.ConstraintDslParserProvider.getParser(
					ConstraintDsl.diagram.providers.ConstraintDslElementTypes.RangeRule_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ConstraintDsl.diagram.edit.parts.ConstraintDslEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
