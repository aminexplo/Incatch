 ...
 * 
 */
package ConstraintDsl.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ConstraintDsl.diagram.part.ConstraintDslDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ConstraintDsl.diagram.part.Messages.MessageFormatParser_InvalidInputError,
