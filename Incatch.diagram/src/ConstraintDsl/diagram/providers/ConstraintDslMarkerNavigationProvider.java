 ...
 * @generated
 */
public class ConstraintDslMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ConstraintDsl.diagram.part.ConstraintDslDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ConstraintDsl.diagram.part.ConstraintDslDiagramEditorUtil.selectElementsInDiagram(editor,
