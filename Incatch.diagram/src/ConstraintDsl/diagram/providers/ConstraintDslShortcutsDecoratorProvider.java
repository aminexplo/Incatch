 ...
 * @generated
 */
public class ConstraintDslShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = ConstraintDsl.diagram.part.ConstraintDslDiagramEditorPlugin.getInstance()
