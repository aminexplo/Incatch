 ...
 * @generated
 */
public class ConstraintDslValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ConstraintDsl.diagram.part.ConstraintDslDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof ConstraintDsl.diagram.part.ConstraintDslDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ConstraintDsl.diagram.edit.parts.ConstraintCollectionEditPart.MODEL_ID
