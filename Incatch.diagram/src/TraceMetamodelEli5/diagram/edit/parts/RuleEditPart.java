...
public class RuleEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TraceMetamodelEli5.diagram.edit.policies.RuleItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TraceMetamodelEli5.diagram.edit.parts.RuleNameEditPart) {
			((TraceMetamodelEli5.diagram.edit.parts.RuleNameEditPart) childEditPart)
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(TraceMetamodelEli5.diagram.part.TraceMetamodelEli5VisualIDRegistry
	...
	*/
	 ...
	 * @generated
	 */
	public class RuleFigure extends Ellipse {
		...
		private void createContents() {
			...
			fFigureRuleLabelFigure.setText("Rule");
