...
public class RuleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new TraceMetamodelEli5.diagram.edit.policies.TraceMetamodelEli5TextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return TraceMetamodelEli5.diagram.providers.TraceMetamodelEli5ElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = TraceMetamodelEli5.diagram.providers.TraceMetamodelEli5ParserProvider.getParser(
					TraceMetamodelEli5.diagram.providers.TraceMetamodelEli5ElementTypes.Rule_2001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					TraceMetamodelEli5.diagram.edit.parts.TraceMetamodelEli5EditPartFactory
