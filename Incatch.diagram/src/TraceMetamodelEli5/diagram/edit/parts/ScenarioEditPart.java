 ...
 * @generated
 */
public class ScenarioEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "TraceMetamodelEli5"; //$NON-NLS-1$
	...
	* @generated
	*/
	public ScenarioEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TraceMetamodelEli5.diagram.edit.policies.ScenarioItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new TraceMetamodelEli5.diagram.edit.policies.ScenarioCanonicalEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				TraceMetamodelEli5.diagram.part.TraceMetamodelEli5VisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new TraceMetamodelEli5.diagram.edit.commands.TraceMetamodelEli5CreateShortcutDecorationsCommand(
