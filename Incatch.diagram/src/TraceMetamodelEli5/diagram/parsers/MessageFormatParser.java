 ...
 * 
 */
package TraceMetamodelEli5.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(TraceMetamodelEli5.diagram.part.TraceMetamodelEli5DiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(TraceMetamodelEli5.diagram.part.Messages.MessageFormatParser_InvalidInputError,
