 ...
 * @generated
 */
public class TraceMetamodelEli5MarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = TraceMetamodelEli5.diagram.part.TraceMetamodelEli5DiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TraceMetamodelEli5.diagram.part.TraceMetamodelEli5DiagramEditorUtil.selectElementsInDiagram(editor,
