 ...
 * @generated
 */
public class TraceMetamodelEli5ValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = TraceMetamodelEli5.diagram.part.TraceMetamodelEli5DiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof TraceMetamodelEli5.diagram.part.TraceMetamodelEli5DiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && TraceMetamodelEli5.diagram.edit.parts.ScenarioEditPart.MODEL_ID
