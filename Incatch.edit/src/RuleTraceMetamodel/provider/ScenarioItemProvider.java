...
/**
 * This is the item provider adapter for a {@link RuleTraceMetamodel.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RuleTraceMetamodelPackage.Literals.SCENARIO__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RuleTraceMetamodelPackage.Literals.SCENARIO__ARTIFACTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Scenario.class)) {
			case RuleTraceMetamodelPackage.SCENARIO__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case RuleTraceMetamodelPackage.SCENARIO__ARTIFACTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RuleTraceMetamodelPackage.Literals.SCENARIO__ARTIFACTS,
				 RuleTraceMetamodelFactory.eINSTANCE.createArtifact()));
	}
