...
/**
 * This is the item provider adapter for a {@link TraceMetamodelEli5.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceMetamodelEli5Package.Literals.SCENARIO__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TraceMetamodelEli5Package.Literals.SCENARIO__RULES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Scenario.class)) {
			case TraceMetamodelEli5Package.SCENARIO__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case TraceMetamodelEli5Package.SCENARIO__RULES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TraceMetamodelEli5Package.Literals.SCENARIO__RULES,
				 TraceMetamodelEli5Factory.eINSTANCE.createRule()));
	}
